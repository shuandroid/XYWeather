...
public class RefreshableRecyclerView extends RecyclerView {
  ...
  public void setAdapter(Adapter adapter) {
    ...
    if (null != adapter) {
      if (adapter instanceof DiscoverListAdapter) {
        ((DiscoverListAdapter)adapter).setFooterView(loadMoreFooterView);
      } else {
  ...
  @Override
  public DiscoverListAdapter getAdapter() {
    return (DiscoverListAdapter)super.getAdapter();
  }
  ...
  private void startLoad() {
    if (STATUS_LAOD_MORE != getLoadStatus()) {
      DiscoverListAdapter adapter = getAdapter();
