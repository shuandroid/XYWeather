...
//    intent.putExtra(MediaStore.EXTRA_OUTPUT, outputUri);
  ...
  public synchronized static void displayAvatar(AVUser user, ImageView avatarView) {
    ...
    if (file != null) {
      ...
      int avatarIds[] = new int[]{R.mipmap.status_avatar0, R.mipmap.status_avatar1,
              R.mipmap.status_avatar3, R.mipmap.status_avatar4,
              R.mipmap.status_avatar5, R.mipmap.status_avatar6};
  ...
  public static DisplayImageOptions normalImageOptions = new DisplayImageOptions.Builder()
      .showImageOnLoading(R.mipmap.empty_photo1)
      .showImageForEmptyUri(R.mipmap.empty_photo1)
      .showImageOnFail(R.mipmap.image_load_fail)
      .cacheInMemory(true)
      .cacheOnDisc(true)
      .considerExifParams(true)
      .imageScaleType(ImageScaleType.EXACTLY)
