...
public class DynamicWeatherViewTest extends SurfaceView implements SurfaceHolder.Callback {

	static final String TAG = DynamicWeatherView.class.getSimpleName();
	private DrawThread mDrawThread;

	public DynamicWeatherViewTest(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
